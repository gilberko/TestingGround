...
private val places = listOf(
    "city / town" to "město", "village" to "vesnice", "country" to "země",
    "street" to "ulice", "road" to "silnice / cesta", "square" to "náměstí",
    "house" to "dům", "apartment / flat" to "byt", "building" to "budova",
    "shop / store" to "obchod", "supermarket" to "supermarket",
    "market" to "tržiště / trh", "bank" to "banka",
    "hospital" to "nemocnice", "pharmacy" to "lékárna",
    "school" to "škola", "university" to "univerzita",
    "library" to "knihovna", "museum" to "muzeum",
    "restaurant" to "restaurace", "café" to "kavárna", "bar" to "bar",
    "hotel" to "hotel", "airport" to "letiště",
    "train station" to "nádraží / vlakové nádraží",
    "bus stop" to "zastávka autobusu", "metro / subway" to "metro",
    "park" to "park", "forest" to "les", "beach" to "pláž",
    "mountain" to "hora", "river" to "řeka", "lake" to "jezero",
    "church" to "kostel", "castle" to "hrad / zámek",
    "cinema" to "kino", "theatre" to "divadlo",
    "post office" to "pošta", "police station" to "policejní stanice",
    "embassy" to "velvyslanectví"
)
