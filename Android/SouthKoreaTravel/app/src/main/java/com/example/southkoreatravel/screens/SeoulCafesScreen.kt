...
fun SeoulCafesScreen(onBack: () -> Unit) {
    ScreenScaffold(title = "Cafes", onBack = onBack) {
        Column(
            ...
            BodyText("Alegria Coffee Roasters, with branches in Gwanghwamun and Pangyo, is also sometimes abbreviated \"ACR\" — worth noting it's a completely different cafe from Anthracite Coffee Roasters above, which shares the same abbreviation. Open since 2011, it offers hand-drip single-origin coffee, espresso, a full bakery line, and affogato including a matcha version.")
            BodyText("Coffee Montage (커피 몽타주), based in Seongnae-dong, Gangdong-gu, with a roasting facility in nearby Hanam, is a Seoul-area roaster (not Gangneung-based, despite that city's coffee-town reputation) known for named espresso blends, single-origin beans, cold brew, and drip bags, supplying beans to roughly 150 cafes nationwide.")
            BodyText("Cafe Pokpo (카페 폭포, \"waterfall cafe\"), in Seodaemun-gu near Hongje Station (Line 3, Exit 4), sits right beside the man-made Hongjecheon waterfall installation, with outdoor riverside seating — especially popular during cherry blossom season.")
            BodyText("Hell Cafe Roasters (헬카페 로스터즈), in Bogwang-dong, Yongsan-gu, was founded in 2013 by an espresso specialist and a hand-drip specialist. The striking name was chosen deliberately to be unforgettable, earning it the local nickname \"Hell Tea House\" — signature drinks include the Hell Drip and Hell Latte.")
            BodyText("Mesh Coffee, in Seongsu-dong, has no indoor seating and focuses on pour-over coffee alongside a signature coffee shake. Felt Coffee (펠트커피), with branches including Gwanghwamun and Dosan Park, is known for its minimalist space and service-focused baristas — these are two separate cafes, not one combined venue.")
            BodyText("A few more worth seeking out: Namusairo, near Gwanghwamun in a renovated hanok, opened in 2002 as one of Seoul's first specialty cafes and is known for its Okinawa Brown Sugar Cappuccino; Manufact Coffee, with a flagship in Yeonhui-dong plus a Seochon branch, for clean, modern-style brews; C.Through Cafe in Yeonnam-dong, known for hand-drawn \"Cream Art\" piped onto espresso drinks; Cafe Knotted, Korea's best-known cream-donut bakery-cafe brand with branches across the city; and NUDAKE Haus Dosan, an avant-garde dessert cafe inside the Gentle Monster building in Apgujeong, known for its matcha-filled \"Peak Cake.\"")
        }
    }
}
