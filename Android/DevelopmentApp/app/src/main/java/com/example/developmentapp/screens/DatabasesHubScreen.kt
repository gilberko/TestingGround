...
fun DatabasesHubScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            DbButtonRow("DB History & Common Terms", onDbHistory, "SQL", onSql)
...
private fun DbButtonRow(
    ...
    Row(
        ...
        DbHubButton(label1, onClick1, Modifier.weight(1f))
        DbHubButton(label2, onClick2, Modifier.weight(1f))
    }
}

@Composable
private fun DbHubButton(label: String, onClick: () -> Unit, modifier: Modifier = Modifier) {
    OutlinedButton(
        onClick  = onClick,
