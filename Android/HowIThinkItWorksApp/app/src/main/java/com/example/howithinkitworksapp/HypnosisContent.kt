    ...
    HypnosisTopic(
        ...
        sections = listOf(
            ...
            TextSection(
                ...
                body = "Pacing does not have to be limited to the obvious or the inevitable. A skilled hypnotist watches closely — and the body is generous with information.\n\nObservable cues include: blink rate and eye movement (the direction the eyes drift can suggest whether the client is visualising, accessing a memory, or talking to themselves internally); breathing — whether it is shallow and chest-level or deep and abdominal, whether it is slowing, whether the client holds breath slightly before exhaling; small hand movements, fingers curling or uncurling, tension releasing; micro-movements in the face — a flicker of muscle around the jaw or brow, a shoulder dropping slightly. Milton Erickson — the most documented practitioner in hypnosis — built a reputation for reading these cues with what felt like uncanny precision. Observed in the moment and woven into the narration, they become pacing: \"and as your breathing slows a little more now...\" or \"and as your hands begin to let go...\"\n\nAn experienced practitioner also brings pattern recognition from previous clients. Certain states — early relaxation, drifting attention, resistance — have physical signatures that appear reliably across different people. A client entering early trance tends to have slightly flattened facial muscle tone, slower blinking, and a subtle heaviness in the eyelids. A practitioner who has seen this many times begins to know what is likely happening internally — and can pace accordingly, describing an inner state the client has not explicitly reported.\n\nThis is where it becomes a calculated risk. Pacing observable facts is safe; pacing an inferred internal state is a bet. An experienced practitioner does not make it as a direct claim — instead, they offer it as a possibility: \"and perhaps there's a part of your mind that is still wondering whether this will work...\" The modal framing — perhaps, there might be, you may notice — means the client is not required to confirm or contradict. If the inference is accurate, the effect is striking: the client feels genuinely perceived, as though the hypnotist has direct access to their inner experience, deepening rapport far beyond what surface-level observation could achieve. If it does not quite land, the client simply passes over it — the possibility was offered, not asserted.\n\nMistakes happen even with skilled practitioners, and how they are handled matters as much as whether they occur. A good hypnotist does not freeze when something does not land as expected. They absorb the moment — moving smoothly forward without drawing attention to the misalignment, or folding the client's reaction back into the narration: \"and even that sense of something not quite fitting is part of the process unfolding...\" This is a version of the utilization Erickson practiced — using whatever arises, including resistance or discordance, rather than treating it as a failure. The session does not need to be flawless; it needs to remain continuous."
            ),
            TextSection(
