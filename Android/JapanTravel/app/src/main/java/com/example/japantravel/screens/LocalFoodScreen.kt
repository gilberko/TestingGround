...
fun LocalFoodScreen(onBack: () -> Unit) {
    ScreenScaffold(title = "Local Food", onBack = onBack) {
        Column(
            ...
            BodyText(
                "Sukiyaki (above) and gyudon (beef bowl, covered under Restaurants, Food Chains " +
                    "and Cafes) are the everyday classics. Yakiniku is grill-it-yourself " +
                    "Korean-Japanese style BBQ - thin-sliced beef cuts cooked at the table over a " +
                    "grill and dipped in sauce. Shabu-shabu is thin-sliced beef swished briefly " +
                    "through a pot of simmering broth at the table until just cooked, then dipped " +
                    "in ponzu or sesame sauce. For a splurge, wagyu steak restaurants (teppanyaki " +
                    "counters or dedicated steakhouses) showcase Japan's famously marbled beef, " +
                    "often graded and priced by region (**Kobe**, **Omi**, **Matsusaka** among the " +
                    "best known)."
            )
