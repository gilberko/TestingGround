...
fun TheLettersScreen() {
    Column(
        ...
        BodyText("د — Dal (d)")
        BodyText("ذ — Dhal (dh → d in colloquial)")
        BodyText("ر — Ra (r — rolled/trilled)")
        BodyText("ز — Zain (z)")
        BodyText("س — Sin (s)")
        BodyText("ش — Shin (sh)")
        ...
        BodyText("ظ — Dha (ẓ → emphatic d in colloquial)")
        ...
        Spacer(modifier = Modifier.height(8.dp))
        BodyText("Six letters are non-connectors — they only connect to the right (the preceding letter) and never to the letter that follows. Their isolated and initial forms are the same, and their medial and final forms are the same.")
        Spacer(modifier = Modifier.height(4.dp))
        BodyText("Non-connectors: ا (Alef) — د (Dal) — ذ (Dhal) — ر (Ra) — ز (Zain) — و (Waw)")
        Spacer(modifier = Modifier.height(8.dp))
        BodyText("All 28 letters — format: alone · start · mid · end")
        Spacer(modifier = Modifier.height(4.dp))
        BodyText("ا (Alef) — non-connector: alone ا · start ا · mid ـا · end ـا")
        BodyText("ب (Ba):    alone ب · start بـ · mid ـبـ · end ـب")
        BodyText("ت (Ta):    alone ت · start تـ · mid ـتـ · end ـت")
        BodyText("ث (Tha):   alone ث · start ثـ · mid ـثـ · end ـث")
        BodyText("ج (Jim):   alone ج · start جـ · mid ـجـ · end ـج")
        BodyText("ح (Ha):    alone ح · start حـ · mid ـحـ · end ـح")
        BodyText("خ (Kha):   alone خ · start خـ · mid ـخـ · end ـخ")
        BodyText("د (Dal) — non-connector: alone د · start د · mid ـد · end ـد")
        BodyText("ذ (Dhal) — non-connector: alone ذ · start ذ · mid ـذ · end ـذ")
        BodyText("ر (Ra) — non-connector:  alone ر · start ر · mid ـر · end ـر")
        BodyText("ز (Zain) — non-connector: alone ز · start ز · mid ـز · end ـز")
        BodyText("س (Sin):   alone س · start سـ · mid ـسـ · end ـس")
        BodyText("ش (Shin):  alone ش · start شـ · mid ـشـ · end ـش")
        BodyText("ص (Sad):   alone ص · start صـ · mid ـصـ · end ـص")
        BodyText("ض (Dad):   alone ض · start ضـ · mid ـضـ · end ـض")
        BodyText("ط (Ta):    alone ط · start طـ · mid ـطـ · end ـط")
        BodyText("ظ (Dha):   alone ظ · start ظـ · mid ـظـ · end ـظ")
        BodyText("ع (Ain):   alone ع · start عـ · mid ـعـ · end ـع")
        BodyText("غ (Ghain): alone غ · start غـ · mid ـغـ · end ـغ")
        BodyText("ف (Fa):    alone ف · start فـ · mid ـفـ · end ـف")
        BodyText("ق (Qaf):   alone ق · start قـ · mid ـقـ · end ـق")
        BodyText("ك (Kaf):   alone ك · start كـ · mid ـكـ · end ـك")
        BodyText("ل (Lam):   alone ل · start لـ · mid ـلـ · end ـل")
        BodyText("م (Mim):   alone م · start مـ · mid ـمـ · end ـم")
        BodyText("ن (Nun):   alone ن · start نـ · mid ـنـ · end ـن")
        BodyText("ه (Ha):    alone ه · start هـ · mid ـهـ · end ـه")
        BodyText("و (Waw) — non-connector: alone و · start و · mid ـو · end ـو")
        BodyText("ي (Ya):    alone ي · start يـ · mid ـيـ · end ـي")
        ...
        BodyText("In urban Palestinian Arabic, ق is pronounced as a glottal stop — a brief, complete closure of the vocal cords. You already make this sound in English: it is the catch in your throat between the two syllables of \"uh-oh\", or the way a Londoner says \"bu'er\" instead of \"butter\".")
        Spacer(modifier = Modifier.height(4.dp))
        BodyText("To produce it: stop all airflow for an instant by pressing your vocal cords together, then release. No tongue contact — it is entirely in the throat.")
        Spacer(modifier = Modifier.height(4.dp))
        BodyText("MSA: qalb (قلب, heart) → Palestinian: 'alb\nMSA: qamar (قمر, moon) → Palestinian: 'amar")
        Spacer(modifier = Modifier.height(4.dp))
        BodyText("Note: Some rural and Bedouin communities in the region retain the original 'q' sound. The glottal stop is the urban norm. The letter hamza (ء) is also a glottal stop — see the Hamza section below.")

        Spacer(modifier = Modifier.height(8.dp))
        BodyText("ر (Ra) → Rolled / Trilled R")
        BodyText("ر is not the soft English 'r' — it is a tapped or trilled r, like the 'r' in Spanish \"pero\" or Italian \"Roma\". The tip of the tongue taps the ridge just behind the upper teeth once (tap) or several times (trill).")
        Spacer(modifier = Modifier.height(4.dp))
        BodyText("Tip: the tongue movement is the same as saying 'd' very fast. Practice by repeating 'd-d-d-d' rapidly until you feel the tap. Then add a vowel around it.")
        Spacer(modifier = Modifier.height(4.dp))
        BodyText("راح (raḥ, he went) — the r is always rolled, never the English soft r\nبرتقال (burtu'aal, orange) — both r's are tapped")

        Spacer(modifier = Modifier.height(8.dp))
        BodyText("Emphatic Letters — ص ض ط ظ")
        BodyText("Arabic has four emphatic (pharyngealized) consonants: ص ض ط ظ. These are the hardest sounds for English speakers to learn.")
        Spacer(modifier = Modifier.height(4.dp))
        BodyText("\"Emphatic\" means you produce the base consonant while simultaneously pulling the back of the tongue toward the throat (pharynx), as if you are about to gargle. This constriction darkens the surrounding vowels — the 'a' near an emphatic letter sounds like the 'a' in \"father\", not the 'a' in \"cat\".")
        Spacer(modifier = Modifier.height(4.dp))
        BodyText("ص (Sad) — emphatic s: like 's' but with the back of the tongue pulled back. صحن (ṣaḥan, plate) sounds darker and heavier than سحر (saḥar, magic).")
        BodyText("ض (Dad) — emphatic d: heavier 'd' with throat constriction. Considered one of the most difficult Arabic sounds. ضيف (ḍeif, guest).")
        BodyText("ط (Ta) — emphatic t: tongue presses hard against the roof with throat constriction. طريق (ṭariq, road) — the ṭ makes the entire word sound deeper.")
        BodyText("ظ (Dha) — in Palestinian Arabic, ظ merges with ض and is pronounced as the emphatic d. ظل (dill, shade) → spoken the same as ض.")
        Spacer(modifier = Modifier.height(4.dp))
        BodyText("These simplifications are a normal feature of the spoken dialect — not errors. The emphatic quality does survive, just shifted onto the nearest emphatic.")
        ...
        Spacer(modifier = Modifier.height(8.dp))
        BodyText("ذ (Dhal) → 'd'")
        BodyText("ذ is the voiced 'th' as in English \"the\" or \"this\". In Palestinian colloquial it simplifies to a plain 'd'.")
        Spacer(modifier = Modifier.height(4.dp))
        BodyText("MSA: hadha (هذا, this) → Palestinian: haada or hada\nMSA: dhakar (ذكر, male) → Palestinian: dakar")
        ...
        SectionHeader("Hamza (ء) and Its Seats")
        BodyText("Hamza (ء) represents the glottal stop consonant — the same catch-in-the-throat sound that ق makes in Palestinian Arabic. But while ق is a standalone letter, hamza is not. It must be written on a carrier (called a \"seat\") that reflects the surrounding vowel environment.")
        Spacer(modifier = Modifier.height(8.dp))
        BodyText("There are four possible seats:")
        BodyText("ء — standalone hamza: used at the end of a word when there is no vowel before it")
        BodyText("أ — hamza above alef: used at the start of a word with an 'a' or 'u' vowel, or in the middle with an 'a' vowel")
        BodyText("إ — hamza below alef: used at the start of a word with an 'i' vowel only")
        BodyText("ؤ — hamza on waw: used when hamza carries or follows a 'u' vowel mid-word")
        BodyText("ئ — hamza on ya: used when hamza carries or follows an 'i' vowel mid-word (the ya loses its dots when used as a seat)")
        Spacer(modifier = Modifier.height(8.dp))
        BodyText("The seat is determined by a priority rule: kasra (i) > damma (u) > fatha (a) > no vowel. Whichever vowel is highest in priority — on hamza itself or the letter before it — determines the seat.")
        Spacer(modifier = Modifier.height(8.dp))
        BodyText("Examples:")
        BodyText("• أكل (akal, he ate) — hamza starts the word with 'a', seat is alef above: أ")
        BodyText("• إيد (iid, hand) — hamza starts the word with 'i', seat is alef below: إ")
        BodyText("• سؤال (su'aal, question) — hamza follows 'u', seat is waw: ؤ")
        BodyText("• بئر (bi'r, well) — hamza follows 'i', seat is ya: ئ")
        BodyText("• شيء (shi', thing) — hamza is at the end after a sukun (no vowel), standalone: ء")
        Spacer(modifier = Modifier.height(8.dp))
        BodyText("In everyday Palestinian colloquial writing — texts, WhatsApp — people often just write أ or ء without strictly following seat rules. The rules matter most in formal and printed Arabic.")
